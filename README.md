...
**This pipeline detects and characterizes small-scale transient brightenings, called "campfires", in Solar Orbiter EUI data. You'll find a .pdf project summary in the root directory, as well as in the README.**
